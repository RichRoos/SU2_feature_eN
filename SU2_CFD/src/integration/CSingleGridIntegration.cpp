...
void CSingleGridIntegration::SingleGrid_Iteration(CGeometry ****geometry, CSolver *****solver_container,
  ...
  if (RunTime_EqSystem == RUNTIME_TURB_SYS) {
	...
	cout << endl <<"------------ RR: CSingleGridIntegration: SingleGrid_iteration - turb restricted sol. done ------------" << endl;
  ...
  if (RunTime_EqSystem == RUNTIME_TRANS_SYS) {
	  ...
	  cout << endl <<"------------ RR: CSingleGridIntegration: SingleGrid_iteration - trans restricted sol. done ------------" << endl;
